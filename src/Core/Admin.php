...
class Admin
{
    ...
    public static function addAdminAssets ($hook)
    {
        if($hook === "toplevel_page_biwyze_tourinsoft_admin") {
            ...
            wp_enqueue_script('biwyze_tourinsoft_admin_js', plugins_url('biwyze_tourinsoft_syndication/assets/js/biwyze_tourinsoft_syndication.js'), ['biwyze_tourinsoft_alpine_js', 'biwyze_tourinsoft_axios_js'], BiwyzeTourinsoftSyndication::VERSION);
